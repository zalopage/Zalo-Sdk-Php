...
//
    ...
    $phone1 = 0; //fone number, you want to check.
    $phone2 = 0; //fone number, you want to check.
    ...
    $userId1 = 0; //fone number, you want to check.
    $userId2 = 0; //fone number, you want to check.
    $lstUserID = array();
